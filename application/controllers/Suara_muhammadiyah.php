...
class Suara_muhammadiyah extends CI_Controller
{
	...
	public function suara_muhammadiyah()
	{
		...
		$this->load->view('suara_muhammadiyah/suara_muhammadiyah', $data);
		$this->load->view('templates/admin_footer');
	}

	public function tambah_data_suaramuhammadiyah()
	{
		$this->load->library('upload');
		...
		if (!empty($_FILES['avatar']['name'])) {
			...
			if ($this->upload->do_upload('avatar')) {
				...
				redirect('suara_muhammadiyah/suara_muhammadiyah');
			}
		}
		...
		$this->load->view('templates/admin_sidebar');
		$this->load->view('templates/admin_navbar');
		$this->load->view('suara_muhammadiyah/tambah_data_suaramuhammadiyah');
		$this->load->view('templates/admin_footer');
	}

	public function edit_data_suaramuhammadiyah($id_suara)
	{
		...
		if ($this->input->post()) {
			...
			if (!empty($_FILES['avatar']['name'])) {
				...
				if ($this->upload->do_upload('avatar')) {
					...
					$this->Suaramuhammadiyah_Model->update_file_path_suaramuhammadiyah($id_suara, $avatar, $suara_muhammadiyah['avatar']);
					...
					redirect('suara_muhammadiyah/suara_muhammadiyah/' . $id_suara);
				} else {
					// Tampilkan pesan error jika unggah gagal
					$error = $this->upload->display_errors();
					echo $error;
			...
			$this->load->view('templates/admin_sidebar');
			$this->load->view('templates/admin_navbar');
			$this->load->view('suara_muhammadiyah/edit_data_berita', $data);
			$this->load->view('templates/admin_footer');
		}
	}
