                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary">
                                <a href="<?php echo base_url('adminor/tambah_surat_notulensi') ?>" class="btn-primary">Tambah Data Agenda</a>
                            </button>
                            <button class="btn btn-secondary">
                                <a href="<?php echo base_url('adminor/tambah_surat_notulensi_agenda') ?>" class="btn-primary">Tambah Data Surat</a>
                            </button>
