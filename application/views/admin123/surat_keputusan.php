                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary">
                                <a href="<?php echo base_url('adminor/tambah_surat_keputusan') ?>" class="btn-primary">Tambah Agenda</a>
                            </button>
                            <button class="btn btn-secondary">
                                <a href="<?php echo base_url('adminor/tambah_surat_keputusan_agenda') ?>" class="btn-primary">Tambah Surat</a>
                            </button>
