                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Breaking News</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            <?php foreach ($breaking_news as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo base_url('breaking_news/edit_data_breaking_news/' . $row['id_news']); ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
                                                        <a href="<?php echo base_url('breaking_news/hapus_data_breaking_news/' . $row['id_news']); ?>" onclick="return confirm('Are you sure you want to delete this item?');" style="color: #e74c3c; "><i class=" fas fa-trash" data-toggle="tooltip" title="Hapus Data"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>
