            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Edit Data Breaking News</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('breaking_news/edit_data_breaking_news/' . $breaking_news['id_news']); ?>" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="isi_content" name="isi_content" value="<?php echo isset($breaking_news['isi_content']) ? $breaking_news['isi_content'] : ''; ?>" required>
                                </div>
                                <div class="mb-3">
