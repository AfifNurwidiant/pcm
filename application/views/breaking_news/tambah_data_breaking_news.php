            ...
            <div class="page-heading">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Tambah Data Breaking News</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?php echo site_url('breaking_news/tambah_data_breaking_news'); ?>" method="post">
                                <div class="mb-3">
