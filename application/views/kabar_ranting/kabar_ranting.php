                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Kabar Ranting</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Kabar Ranting</h4>
                                            ...
                                            <?php foreach ($kabar_ranting as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo base_url('kabar_ranting/edit_data_kabar_ranting/' . $row['id_kabar_ranting']); ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
                                                        <a href="<?php echo base_url('kabar_ranting/hapus_data_kabar_ranting/' . $row['id_kabar_ranting']); ?>" onclick="return confirm('Are you sure you want to delete this item?');" style="color: #e74c3c; "><i class=" fas fa-trash" data-toggle="tooltip" title="Hapus Data"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>
