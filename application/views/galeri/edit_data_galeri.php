            ...
            <div class="page-heading">
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('galeri/edit_data_galeri/' . $galeri['id_galeri']); ?>" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="isi_content" name="isi_content" value="<?php echo isset($galeri['isi_content']) ? $galeri['isi_content'] : ''; ?>" required>
                                </div>
                                <div class="mb-3">
