                                            ...
                                            <?php foreach ($galeri as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo base_url('galeri/edit_data_galeri/' . $row['id_galeri']); ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
                                                        <a href="<?php echo base_url('galeri/hapus_data_galeri/' . $row['id_galeri']); ?>" onclick="return confirm('Are you sure you want to delete this item?');" style="color: #e74c3c; "><i class=" fas fa-trash" data-toggle="tooltip" title="Hapus Data"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>
